...
# a_transform = [
#     dict(type='RandomRotate', p=0.3),
#     dict(type='Blur', blur_limit=3, p=0.2),
#     dict(type='ColorJitter', brightness=0.2, contrast=0.2, saturation=0.2, hue=0.2, p=0.2)
# ]

image_scale = [(512, 512),(640,640),(768,768),(896,896),(1024,1024)]

# Default Setting (Resize, RandomFlip, Normalize, Pad, DefaultFormatBundle, Collect)
train_pipeline = [
    dict(type="Resize", img_scale=image_scale, multiscale_mode='value', keep_ratio=True),  # Don't fix it
